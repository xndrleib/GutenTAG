...
![python version 3.11|3.12|3.13|3.14](https://img.shields.io/badge/python-3.11%20%7C%203.12%20%7C%203.13%20%7C%203.14-blue)
...
1. Install GutenTAG from [PyPI](https://pypi.org/project/timeeval-gutenTAG/):
   ...
   GutenTAG supports Python 3.11, 3.12, 3.13, and 3.14; all runtime requirements are installed with the pip-call above.
